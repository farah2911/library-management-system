...
<div id="header"> <img src="../images/h9.jpg" height=600px, width=1300px/></div>
<div id="slide1"> <p> Borrow. <span>Read.</span> Repeat. </p> </div>
...
echo "<form id='searchMember' method='post' action='memberFinal.php'>    
MemberId:
<input type='text' name='memberId'/>
<input type='submit' name='search' value='search' />";   //member search form
...
echo "<form class='detail' action='memberFinal.php'>";
...
echo "<table class='memberTable' border='1'><tr>
<th>TransId </th>
<th>MemberId</th>
<th>Acc.No.</th>
<th>IssueDate</th>
...
echo "<form class='detail'method='post' action='memberFinal.php'>";
...
echo "<tr><form class='detail' method='post' action='memberResult.php'>
